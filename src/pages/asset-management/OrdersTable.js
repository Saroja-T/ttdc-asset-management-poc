...
const rows = [
  createData(1, 'Camera Lens', 40),
  createData(2, 'Laptop', 300),
  createData(3, 'Mobile', 355),
  createData(4, 'Handset', 50),
  createData(5, 'Computer Accessories', 100),
  createData(6, 'TV', 99),
  createData(7, 'Keyboard', 125),
  createData(8, 'Mouse', 89),
  createData(9, 'Desktop', 185),
  createData(10, 'Chair', 100)
];
